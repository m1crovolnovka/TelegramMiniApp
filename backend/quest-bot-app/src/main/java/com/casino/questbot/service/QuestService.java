...
import com.casino.questbot.repo.QuestAssignmentRepository;
import com.casino.questbot.repo.QuestTaskRepository;
...
public class QuestService {
    ...
    public CreateQuestResult createQuest(UserEntity initiator, UserEntity partner) {
        ...
        if (assignments.findActiveForUser(initiator).isPresent()) {
            return CreateQuestResult.fail("У вас уже есть активное задание. Сначала выполните его или откажитесь.");
        }
    ...
    public Optional<QuestAssignmentEntity> approveAssignment(long assignmentId) {
        ...
        casinoApiClient.completePartnerQuest(
